...
using System.Linq;
using AutoMapper;
using StackOverflowMVC.ViewModels;
using StackOverflowMVC.Repositories;
using StackOverflowMVC.DomainModels;
using StackOverflowMVC.ServiceLayer;

namespace StackOverflowMVC.ServiceLayer
{
    ...
    public class UsersService : IUsersService
    {
        ...
        public int InsertUser(RegisterViewModel uvm)
        {
            ...
            u.PasswordHash = SHA256HashGenerator.GeneratedHash(uvm.Password);
            ur.InsertUser(u);
        ...
        {
            User u = ur.GetUsersByEmailAndPassword(Email, SHA256HashGenerator.GeneratedHash(Password)).FirstOrDefault();
