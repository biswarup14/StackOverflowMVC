...
namespace StackOverflowMVC.Repositories
{
    public interface IQuestionRepository
    {
        void InsertQuestion(Question q);
        void UpdateQuestionDetails(Question q);
        void UpdateQuestionVotesCount(int qid, int value); //here the value can be +1(upvote) or -1(downvote) 
    ...
    public class QuestionsRepository : IQuestionRepository
    {
        ...
        public void UpdateQuestionVotesCount(int qid, int value)
        {
            ...
            if (qt != null)
            {
                qt.VotesCount = qt.VotesCount + value;
                db.SaveChanges();
            }
        }
        public void UpdateQuestionAnswersCount(int qid, int value)
        {
            ...
            if (qt != null)
            {
                qt.AnswersCount = qt.AnswersCount + value;
                db.SaveChanges();
            }
        }
        public void UpdateQuestionViewsCount(int qid, int value)
        {
            ...
            if (qt != null)
            {
                qt.ViewsCount = qt.ViewsCount + value;
                db.SaveChanges();
            }
        }
